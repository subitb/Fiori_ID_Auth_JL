sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("webapp/Fiori_ID_Auth_JL/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("webapp.Fiori_ID_Auth_JL.test.integration.arrangements.Arrangement", {
