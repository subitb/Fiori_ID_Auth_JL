...
sap.ui.define([
		...
		"sap/ui/Device",
		"webapp/Fiori_ID_Auth_JL/model/formatter"
	], function (BaseController, JSONModel, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, formatter) {
		"use strict";

		return BaseController.extend("webapp.Fiori_ID_Auth_JL.controller.Master", {
			...
			onInit : function () {
				...
				this._oGroupFunctions = {
					UnitPrice : function(oContext) {
						var iGrouper = oContext.getProperty('UnitPrice'),
							key, text;
						if (iGrouper <= 20) {
							key = "LE20";
			...
			onOpenViewSettings : function (oEvent) {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("webapp.Fiori_ID_Auth_JL.view.ViewSettingsDialog", this);
